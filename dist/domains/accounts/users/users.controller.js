...
usersController.post("/sign-up", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
usersController.post("/log-in", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {

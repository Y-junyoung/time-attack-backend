...
const userProfile_controller_1 = __importDefault(require("./userProfile/userProfile.controller"));
...
accountsController.use("/users", userProfile_controller_1.default);
